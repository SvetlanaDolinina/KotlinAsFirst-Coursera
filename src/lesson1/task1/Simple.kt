 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg * 3600.0) + (min * 60.0) + sec) * 4.8481368110954E-6
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    return ((((initial * percent / 100.0) + initial)
            * percent / 100.0
            + ((initial * percent / 100.0) + initial))
            * percent / 100.0
